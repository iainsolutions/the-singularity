#!/usr/bin/env python3
"""
Scenario Test: Space Traffic (age 11, green)

Effects:
- Effect 0: Draw and tuck an 11. If you tuck directly under an 11, you lose.
  Otherwise, score all but your top five cards of the color of the tucked card,
  splay that color aslant, and if you do not have the highest score, you win.

Setup: Human has Space Traffic on board. AI has Agriculture.
"""
...
class TestSpaceTrafficScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Space Traffic", "location": "board"})
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
    ...
    def test_space_traffic_tuck_and_splay(self):
        ...
        # May trigger win/lose condition
        assert pending is None or phase != "playing"
        print("✅ Space Traffic test PASSED")
