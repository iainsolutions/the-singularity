#!/usr/bin/env python3
"""
Scenario Test: Genetics (age 9, blue)

Effects:
- Effect 0: Draw and meld an 11. Score all cards beneath it.
  Primitives: DrawCards (11), MeldCard, ScoreCards (stack_beneath)

Setup:
- Human: Genetics on board (lightbulb symbols)
- AI: Agriculture (0 lightbulbs) - no sharing
- Human: Clothing on board (blue) - will be beneath the melded 11
"""
...
class TestGeneticsScenario:
    """Test Genetics draw/meld 11 + score beneath."""
    ...
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Genetics", "location": "board"})
        # Add a blue card that will get pushed beneath when meld 11 (if 11 is blue)
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
    ...
    def test_genetics_draw_meld_score_beneath(self):
        """Test Genetics: draw/meld 11, score cards beneath."""
        ...
        response = requests.post(
            ...
            json={"player_id": human_id, "action_type": "dogma", "card_name": "Genetics"}
        )
        assert response.status_code == 200
        time.sleep(2)
