#!/usr/bin/env python3
"""
Scenario Test: Robotics (age 10, red)

Effects:
- Effect 0: Score your top green card.
- Effect 1: Draw and meld a 10. If it has factory, execute each of its effects.

Setup: Human has Robotics + Electricity (green, has factory) on board.
"""
...
class TestRoboticsScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Robotics", "location": "board"})
        # Green card to score
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
