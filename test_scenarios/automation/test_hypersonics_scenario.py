#!/usr/bin/env python3
"""
Scenario Test: Hypersonics (age 11, green)

Effects:
- Effect 0 (DEMAND): I demand you return exactly two top cards of different colors from your board
  of the same value! If you do, return all cards of that value or less in your hand and score pile!

Setup: Human has Hypersonics on board (more factory symbols). AI has Agriculture.
Demand skipped since AI has fewer factory symbols.
"""
...
class TestHypersonicsScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Hypersonics", "location": "board"})
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
