#!/usr/bin/env python3
"""
Scenario Test: Whataboutism (age 11, purple)

Effects:
- Effect 0 (DEMAND): I DEMAND you transfer a top card with a demand effect of each color
  from your board to my board! If you transfer any cards, exchange all cards in your score
  pile with all cards in my score pile!

Setup: Human has Whataboutism on board (more lightbulb). AI has Agriculture.
Demand skipped since AI has fewer lightbulb symbols.
"""
...
class TestWhataboutismScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Whataboutism", "location": "board"})
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
    ...
    def test_whataboutism_demand(self):
        ...
        print("✅ Whataboutism test PASSED")
