#!/usr/bin/env python3
"""
Scenario Test: Suburbia (age 9, yellow)

Effects:
- Effect 0: You may tuck any number of cards from hand. Draw and score a 1 for each tucked.
- Effect 1: You may junk all cards in the 9 deck.

Setup: Human has Suburbia on board + Paper in hand
"""
...
class TestSuburbiaScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Suburbia", "location": "board"})
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
