#!/usr/bin/env python3
"""
Scenario Test: Astrogeology (age 11, red)

Effects:
- Effect 0: Draw and reveal an 11. Splay its color on your board aslant. If you do,
  transfer all but your top four cards of that color into your hand.
- Effect 1: If you have at least eight cards in your hand, you win.

Setup: Human has Astrogeology on board. AI has Agriculture.
"""
...
class TestAstrogeologyScenario:
    def setup_scenario(self) -> dict[str, Any]:
        ...
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
                      json={"player_id": human_id, "card_name": "Astrogeology", "location": "board"})
        requests.post(f"{BASE_URL}/admin/dev/admin/games/{game_id}/set-card",
    ...
    def test_astrogeology_reveal_splay_win(self):
        ...
        print("✅ Astrogeology test PASSED")
